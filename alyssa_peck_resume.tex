    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                % \item Performed Budget vs Actual (BvA) analysis for engagement teams to assess project profitability and resource allocation
                ...
                \item Built end-to-end data pipelines using ETL processes to provide key insights on financial metrics, trends, and correlations, working with cloud platforms including Snowflake to pull ERP data
                ...
                % \item Experienced in complex technical accounting matters, including stock-based compensation, leases, capitalized software, investments, revenue recognition, convertible debt, ASC 842, ASC 606 % consider adding these as skills?
